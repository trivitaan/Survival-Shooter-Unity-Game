...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Awake()
    {
        //mendapatkan nilai mask dari layer bernama floor
    ...
    //method player untuk berjalan
    void Move(float h, float v)
    {
        //set nilai x dan y
        movement.Set(h, 0f, v);

        //menormalisasi nilai vector agar total panjjang dari vector adalah 1
    ...
    void Turning()
    {
        ...
        {
            //mendapatkan vektor dari posisi player dan posisi floorhit
